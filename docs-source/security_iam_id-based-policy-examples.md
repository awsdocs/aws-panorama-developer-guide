# AWS Panorama identity\-based policy examples<a name="security_iam_id-based-policy-examples"></a>
...
## Using the AWS Panorama console<a name="security_iam_id-based-policy-examples-console"></a>
